 ...
 * @version 1.0
 *//*
public class TreeTagForCataTree extends BodyTagSupport {
    Logger log = Logger.getLogger(TreeTag.class);

    public TreeTagForCataTree() {
    }
    ...
    String getTree() {
        if (attributeName != null) {
            return (String) ReqUtil.look(pageContext, attributeName, 2);
        }
